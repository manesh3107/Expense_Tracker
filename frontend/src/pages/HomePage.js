  ...
  const handleDelete = async () => {
    try {
      ...
      await axios.post("/transections/delete-transection", {
        transacationId: deleteRecord._id,
      });
      setLoading(false);
      message.success("Transaction Deleted!");
  
      // After deleting, update the list of transactions with the current filters
      const updatedTransactions = await axios.post("/transections/get-transection", {
        userid: user._id,
        frequency,
        selectedDate,
        type,
      });
      setAllTransection(updatedTransactions.data);
